...
export const JOURNEY_WEAPON_META = {
  ...
  gutter_stiletto: {
    label: "Gutter stiletto",
    tier: "Uncommon",
    description: "A narrow rogue's blade built for gaps, ribs, and getting gone quickly.",
    attackType: "pierce",
    bonuses: { might: 0, finesse: 2, arcana: 0, vitality: 0, resolve: 1 },
  },
  soldiers_mace: {
    label: "Soldier's mace",
    tier: "Uncommon",
    description: "Compact iron meant for shields, helmets, and finishing a rush.",
    attackType: "strike",
    bonuses: { might: 2, finesse: 0, arcana: 0, vitality: 0, resolve: 1 },
  },
  ashwood_bow: {
    label: "Ashwood bow",
    tier: "Rare",
  ...
  duelists_rapier: {
    label: "Duelist's rapier",
    tier: "Rare",
    description: "Precise steel that rewards posture, timing, and nerve over brute force.",
    attackType: "pierce",
    bonuses: { might: 1, finesse: 2, arcana: 0, vitality: 0, resolve: 1 },
  },
  smokeglass_censer: {
    label: "Smokeglass censer",
    tier: "Rare",
    description: "A weighted censer chained for fighting, still smelling of bitter alchemy.",
    attackType: "strike",
    bonuses: { might: 0, finesse: 1, arcana: 1, vitality: 0, resolve: 2 },
  },
  mercywood_staff: {
    label: "Mercywood staff",
    tier: "Rare",
    description: "A long staff wrapped in prayer cord and old field dressings.",
    attackType: "strike",
    bonuses: { might: 0, finesse: 0, arcana: 1, vitality: 1, resolve: 2 },
  },
  wardens_arming_sword: {
    label: "Warden's arming sword",
    tier: "Epic",
    description: "A knightly blade balanced to hold a line and finish it cleanly.",
    attackType: "slash",
    bonuses: { might: 2, finesse: 1, arcana: 0, vitality: 1, resolve: 1 },
  },
  ruin_greatblade: {
